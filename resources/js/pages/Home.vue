        ...
        <div class="mx-auto text-center">
          <div class="row justify-content-center">
            <div class="custom-image" data-aos="fade-in" data-aos-delay="300" data-aos-duration="1100">
              <img class="img-fluid" v-bind:src="'/images/phflag.png'" loading="lazy" />
            </div>
          </div>
          ...
          <div class="row justify-content-center">
            ...
            >The first Coptic Orthodox Church in the Philippines ministering the Word of God and serving congregants worldwide through it’s websites and TV programs.</p>
          </div>
          <div class="row justify-content-center mt-3">
            <a class="button button--secondary" href="#aboutus" role="button" data-aos="fade-up" data-aos-offset="0" data-aos-duration="1100">Learn More</a>
            <a role="button" href="/schedules" class="button button--secondary" data-aos="fade-up" data-aos-offset="0" data-aos-delay="200" data-aos-duration="1000">Schedules &nbsp;<i class="fas fa-clock"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="container mt-4 mb-3 pl-3 pr-3" style="overflow-x:hidden">
        <div class="col-sm-12 col-md-12 col-lg-12">
          ...
          <div class="row align-items-center no-gutters mb-4 mt-3 mb-lg-5">
            <div
              class="col-xl-6 col-lg-5 mx-auto pt-3"
              data-aos="fade-right"
              data-aos-duration="1400"
            >
            ...
            <div
              class="col-xl-4 col-lg-5 mx-auto content-info"
              data-aos="fade-left"
              data-aos-duration="1400"
            >
              <div class="text-center text-lg-left">
                ...
                >Mark the Evangelist is the traditionally ascribed author of the Gospel of Mark. Mark is said to have founded the Church of Alexandria, one of the most important episcopal sees of early Christianity.</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div id="services" class="container mt-3 mb-3">
      <div class="container mt-4 mb-3 pl-3 pr-3">
        <div class="col-sm-12 col-md-12 col-lg-12">
          ...
          <div
            class="row align-items-center no-gutters mb-4 mt-3 mb-lg-5"
            data-aos="fade-right"
            data-aos-duration="1400"
          >
            <div class="col-xl-6 col-lg-5 mx-auto pt-3">
              <img
                ...
                v-bind:src="'/images/image-placeholder.jpg'"
                loading="lazy"
              />
            </div>
            <div
            ...
            >
              <div class="text-center text-lg-left">
                ...
                <p
                  class="header-secondary text-dark"
                >Saint Mark Bible study is hosted every Sunday at 11 AM.Learning and Sharing with other members. Join Us Now!</p>
              </div>
            </div>
          </div>
          <div
          ...
          >
            ...
            >
              <div class="text-center text-lg-left">
                ...
                <p
                  class="header-secondary text-dark"
                >Saint Mark offers sunday school for all grades from Pre-K to college and grad. Have fun while Learning. Join Us Now!</p>
              </div>
            </div>
          </div>
          <div
          ...
          >
            ...
            >
              <div class="text-center text-lg-left">
                ...
                <p
                  class="header-secondary text-dark"
                >The Orthodox Church has a long and rich history of theology and revelation. In the following pages we hope to help explain how the Eastern Orthodox Church understands the Church, God, and our place in relationship with them both.</p>
              </div>
            </div>
          </div>
        </div>
